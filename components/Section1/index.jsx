...
const Sector1 = () => {
	return (
		<div className='  lg:h-80vh p-3 sm:p-8 md:px-16 flex items-center justify-center '>
			<div className='hero flex mt-20  lg:-mt-12 lg:flex-row flex-col'>
				<div className='hero-text lg:w-1/2  p-3 flex flex-col flex-nowrap  justify-center items-start space-y-8 pr-0 sm:pr-12 md:pr-40'>
					<h1 className='hero-title text-4xl font-bold tracking-wider'>Welcome to GDSC-WCE </h1>
					<p className='hero-description  text-gray-500 font-semibold leading-5'>
					...
					<Link href='#' className='learn-more bg-gdsc-blue drop-shadow-lg text-white px-6 py-2  rounded-full'>Learn More</Link>
				</div>
